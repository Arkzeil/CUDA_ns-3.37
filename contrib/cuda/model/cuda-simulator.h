...
template <
    ...
    typename... Ts>
EventId
Cuda_Simulator::Schedule(const Time& delay, FUNC f, Ts&&... args)
{
...
template <typename... Us, typename... Ts>
EventId
Cuda_Simulator::Schedule(const Time& delay, void (*f)(Us...), Ts&&... args)
{
    return DoSchedule(delay, MakeEvent(f, std::forward<Ts>(args)...));
}
...
template <
    ...
    typename... Ts>
void
Cuda_Simulator::ScheduleWithContext(uint32_t context, const Time& delay, FUNC f, Ts&&... args)
{
...
template <typename... Us, typename... Ts>
void
Cuda_Simulator::ScheduleWithContext(uint32_t context, const Time& delay, void (*f)(Us...), Ts&&... args)
{
    return ScheduleWithContext(context, delay, MakeEvent(f, std::forward<Ts>(args)...));
}
...
template <
    ...
    typename... Ts>
EventId
Cuda_Simulator::ScheduleNow(FUNC f, Ts&&... args)
{
...
template <typename... Us, typename... Ts>
EventId
Cuda_Simulator::ScheduleNow(void (*f)(Us...), Ts&&... args)
{
    return DoScheduleNow(MakeEvent(f, std::forward<Ts>(args)...));
}
...
template <
    ...
    typename... Ts>
EventId
Cuda_Simulator::ScheduleDestroy(FUNC f, Ts&&... args)
{
...
template <typename... Us, typename... Ts>
EventId
Cuda_Simulator::ScheduleDestroy(void (*f)(Us...), Ts&&... args)
{
    return DoScheduleDestroy(MakeEvent(f, std::forward<Ts>(args)...));
}
