#ifndef BRIDGED_P2P_NET_DEVICE_H
#define BRIDGED_P2P_NET_DEVICE_H
...
namespace ns3
{
    ...
    class BridgedP2PChannel;
    class ErrorModel;
    class BridgedPointToPointNetDevice : public PointToPointNetDevice {
        public:
            static TypeId GetTypeId();
            BridgedPointToPointNetDevice();
            virtual ~BridgedPointToPointNetDevice() override;
            // Delete copy constructor and assignment operator to avoid misuse
            BridgedPointToPointNetDevice& operator=(const BridgedPointToPointNetDevice&) = delete;
            BridgedPointToPointNetDevice(const BridgedPointToPointNetDevice&) = delete;
             ...
             */
            bool Attach(Ptr<BridgedP2PChannel> ch);
            ...
            /**
             * Receive a packet from a connected BridgedP2PChannel.
             *
        ...
        private:
             ...
             *
             * \see BridgedP2PChannel::TransmitStart ()
            ...
            /**
             * The BridgedP2PChannel to which this PointToPointNetDevice has been
             * attached.
             */
            Ptr<BridgedP2PChannel> m_channel;
...
#endif // BRIDGED_P2P_NET_DEVICE_H