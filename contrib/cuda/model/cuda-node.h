 ...
 * \ingroup network
 *
 * \brief A network Cuda_Node.
 *
 * This class holds together:
 *   - a list of NetDevice objects which represent the network interfaces
 *     of this node which are connected to other Cuda_Node instances through
 *     Channel instances.
 *   - a list of Application objects which represent the userspace
 *     traffic generation applications which interact with the Cuda_Node
 *     through the Socket API.
 *   - a node Id: a unique per-node identifier.
 *   - a system Id: a unique Id used for parallel simulations.
 *
 * Every Cuda_Node created is added to the Cuda_NodeList automatically.
 */
    class Cuda_Node : public Object
    {
        public:
            /**
             ...
             *
             * This unique id happens to be also the index of the Cuda_Node into
             * the Cuda_NodeList.
             */
             ...
             * \returns the index of the NetDevice into the Cuda_Node's list of
             *          NetDevice.
             */
            ...
            /**
             * \brief Associate an Application to this Cuda_Node.
             *
             * \param application Application to associate to this node.
             * \returns the index of the Application within the Cuda_Node's list
             *          of Application.
             */
            ...
            /**
             * \returns the number of Application instances associated to this Cuda_Node.
             */
        ...
        protected:
             ...
             * and must chain up to it by calling Cuda_Node::DoDispose at the
