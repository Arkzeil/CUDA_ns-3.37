#ifndef BRIDGED_P2P_HELPER_H
#define BRIDGED_P2P_HELPER_H
 ...
 * "mixins".
 */
class BridgedP2PHelper : public PointToPointHelper
{
  public:
    /**
     * Create a BridgedP2PHelper to make life easier when creating point to
     * point networks.
     */
    BridgedP2PHelper();

    ~BridgedP2PHelper() override
    {
    }
     ...
     * PointToPointNetDevice created through BridgedP2PHelper::Install.
     */
     ...
     * attributes configured by BridgedP2PHelper::SetChannelAttribute,
...
template <typename... Ts>
void
BridgedP2PHelper::SetQueue(std::string type, Ts&&... args)
{
